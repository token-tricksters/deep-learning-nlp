...
# Run the script:
python -u multitask_classifier.py --use_gpu --batch_size 64 --option finetune --samples_per_epoch 10000 --epochs 50 --weight_decay 0.1  --tensorboard_subfolder optimizer
